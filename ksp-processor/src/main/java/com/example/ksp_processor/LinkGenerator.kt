...
import com.example.ksp_processor.descriptors.ContainerPropertyDescriptor
import com.example.ksp_processor.descriptors.PropertyDescriptor
import com.example.ksp_processor.descriptors.SimpleClassDescriptor
...
class LinkGenerator(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val annotated = resolver.getSymbolsWithAnnotation<Link>()
