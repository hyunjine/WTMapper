...
package com.example.ksp_processor.descriptors

import com.example.ksp_processor.Swap
...
sealed interface PropertyDescriptor {
    ...
    companion object {
        ...
        fun fromPropertyDeclaration(prop: KSPropertyDeclaration, hasDefault: Boolean): PropertyDescriptor {
            ...
            val defaultAnnotation = prop.getAnnotationsByType(Swap::class).firstOrNull()
